...
public class IvMClassifierChooser extends JPanel {
	...
	private final JComboBox<AttributeClassifier> combobox;
	...
	public AttributeClassifier[] getSelectedClassifier() {
		return (AttributeClassifier[]) combobox.getSelectedObjects();
	}
	...
	public JComboBox<AttributeClassifier> getMultiComboBox() {
		return combobox;
	}
