...
public class GoalDrivenObject<C> extends IvMObject<C> {
	...
	public static final IvMObject<MapActivityCategoryObject> map_activity_category = c("Mapping of activities to new categories",
			MapActivityCategoryObject.class);
	...
	public static final IvMObject<CategoryObject> selected_mode_category= c("selected mode of view for new category", CategoryObject.class);
	public static final IvMObject<IndirectedEdgeCarrierObject> indirected_edges= c("indirected edges in the high-level dfg", IndirectedEdgeCarrierObject.class);
