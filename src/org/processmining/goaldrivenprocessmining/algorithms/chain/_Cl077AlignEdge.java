...
public class _Cl077AlignEdge extends DataChainLinkComputationAbstract<GoalDrivenConfiguration> {
	...
	public IvMObject<?>[] createInputObjects() {
		return new IvMObject<?>[] {  GoalDrivenObject.selected_classifier1, GoalDrivenObject.low_level_dfg,
				 };
	}
...
//		cache.put(cacheKey, new SoftReference<IvMLogNotFiltered>(aLog));
		...
		return new IvMObjectValues();//
//				s(GoalDrivenObject.aligned_log_edge, null).//
//				s(GoalDrivenObject.aligned_log_info_edge, null);
	}
}